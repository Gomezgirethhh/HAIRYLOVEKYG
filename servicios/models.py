...
from usuarios.models import Usuario, Especialista
...
class RespuestaDiagnostico(models.Model):
    ...
    especialista = models.ForeignKey(Especialista, on_delete=models.SET_NULL, null=True, related_name='diagnosticos')
